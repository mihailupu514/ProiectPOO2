...
public:
    ...
    bool operator==(const ProgramTraining &rhs) const {
        return index == rhs.index &&
               numarAbsolventi == rhs.numarAbsolventi;
    }
...
public:
    bool operator==(const Finantist &rhs) const {
        return static_cast<const ProgramTraining &>(*this) == static_cast<const ProgramTraining &>(rhs) &&
               index == rhs.index &&
               notaFinanciar == rhs.notaFinanciar &&
               notaAlgebra == rhs.notaAlgebra &&
               Medie == rhs.Medie &&
               MedieRotunjita == rhs.MedieRotunjita;
    }
...
protected:
    ...
    float notaAnaliza;
public:
    bool operator==(const Programator &rhs) const;
...
bool Programator::operator==(const Programator &rhs) const {
    return static_cast<const ProgramTraining &>(*this) == static_cast<const ProgramTraining &>(rhs) &&
           index == rhs.index &&
           notaAlgebra == rhs.notaAlgebra &&
           notaAnaliza == rhs.notaAnaliza &&
           notaGeometrie == rhs.notaGeometrie &&
           notaEngleza == rhs.notaEngleza &&
           notaJava1 == rhs.notaJava1 &&
           notaJava2 == rhs.notaJava2 &&
           notaC1 == rhs.notaC1 &&
           notaC2 == rhs.notaC2 &&
           medie == rhs.medie &&
           medieRotunjita == rhs.medieRotunjita;
...
public:
    ...
    bool operator==(const ManagerEchipaProgramator &rhs) const;
...
bool ManagerEchipaProgramator::operator==(const ManagerEchipaProgramator &rhs) const {
    return static_cast<const ProgramTraining &>(*this) == static_cast<const ProgramTraining &>(rhs) &&
           index == rhs.index &&
           notaengleza == rhs.notaengleza &&
           notahr == rhs.notahr &&
...
public:
    ...
    bool operator==(const Sofer &rhs) const;
...
bool Sofer::operator==(const Sofer &rhs) const {
    return static_cast<const ProgramTraining &>(*this) == static_cast<const ProgramTraining &>(rhs) &&
           index == rhs.index &&
           notaLegislatie == rhs.notaLegislatie &&
           notaSofat == rhs.notaSofat &&
           medie == rhs.medie &&
           medieRotunjita == rhs.medieRotunjita;
}
...
public:
    ...
    bool operator==(const ManagerEchipaTiristi &rhs) const;
...
bool ManagerEchipaTiristi::operator==(const ManagerEchipaTiristi &rhs) const {
    return static_cast<const ProgramTraining &>(*this) == static_cast<const ProgramTraining &>(rhs) &&
           index == rhs.index &&
           notaEngleza == rhs.notaEngleza &&
           notaHR == rhs.notaHR &&
           notaFinanciar == rhs.notaFinanciar &&
           notaTurca == rhs.notaTurca &&
           notaLegislatie == rhs.notaLegislatie &&
           Medie == rhs.Medie &&
           MedieRotunjita == rhs.MedieRotunjita;
}
...
public:
    ...
    public:
        ...
        bool operator==(const Cursant &rhs) const;
...
bool Cursuri::Cursant::operator==(const Cursuri::Cursant &rhs) const {
    return index == rhs.index &&
           nume == rhs.nume &&
           productivitate == rhs.productivitate &&
           varsta == rhs.varsta &&
           CursuriAlese == rhs.CursuriAlese &&
           numar_CursuriAlese == rhs.numar_CursuriAlese &&
           competentaF == rhs.competentaF &&
           competentaM == rhs.competentaM &&
           competentaP == rhs.competentaP &&
           competentaS == rhs.competentaS &&
           competentaMEP == rhs.competentaMEP &&
           competentaMET == rhs.competentaMET;
}
